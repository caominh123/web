...
/**
 * Servlet implementation class XoaThanhVienLop
 */
@WebServlet("/XoaThanhVienLop")
public class XoaThanhVienLop extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public XoaThanhVienLop() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            DBUtils.XoaThanhVienLop(conn, MaThanhVien, MaLop);
