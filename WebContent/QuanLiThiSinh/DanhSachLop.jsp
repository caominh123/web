                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${lopList}" var="lop">
                                            <tr>
								            	...
								            	<td>${lop.tenLop}</td>
								              	<td>${lop.ngayLap}</td>
                                                <td><a href="DanhSachThanhVienLop?MaLop=${lop.maLop}"><i class="fa fa-eye"></i></a></td>
                                                <td><a href="SuaLop?MaLop=${lop.maLop}"><i class="fa fa-edit (alias)"></i></a></td>
                                                <td><a href="XoaLop?MaLop=${lop.maLop}"><i class="fa fa-trash-o"></i></a></td>
                                            </tr>
