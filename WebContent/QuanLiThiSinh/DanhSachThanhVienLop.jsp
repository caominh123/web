                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Danh Sách Thành Viên lớp ${MaLop}</strong>
                            </div>
                            <div class="card-body">
                            <p style="color: red">${errorString}</p>
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${thanhvienlop}" var="tv">
                                            <tr>
                                                <td>${tv.maThanhVien}</td>
								            	<td>${tv.tenThanhVien}</td>
								              	<td>${tv.email}</td>
								              	<td>${tv.passWord}</td>
                                                <td><a href="XoaThanhVienLop?MaThanhVien=${tv.maThanhVien}&&MaLop=${MaLop}"><i class="fa fa-trash-o"></i></a></td>
                                            </tr>
