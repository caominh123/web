                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <p style="color: red;">${errorString}</p>
                                <form action="${pageContext.request.contextPath}/ThemLop" method="post" class="form-horizontal">
                                    <div class="col-lg-6">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="MaLop" value="${lop.maLop}"
                                    ...
                                    <div class="col-lg-6">
	                                        <div class="row form-group">
	                                            <div class="col col-md-4"><label for="text-input" class=" form-control-label">Chọn thành viên
