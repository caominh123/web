                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <p style="color: red;">${errorString}</p>
                                <form action="${pageContext.request.contextPath}/ThemCauHoi" method="post" class="form-horizontal">
                                    <div class="col-lg-6">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="MaCauHoi" value="${question.maCauHoi}"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><textarea class="form-control" name ="NoiDung"></textarea></div>
                                        </div>
                                    </div>
                                   	<div class="col-lg-6">
                                        <div class="row form-group">
