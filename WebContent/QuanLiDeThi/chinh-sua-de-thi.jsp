                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <p style="color: red;">${errorEditDeThi}</p>
                                <form action="${pageContext.request.contextPath}/ChinhSuaDeThi" method="post" class="form-horizontal">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="hidden" name="maDe" value="${maDe}">
                                            ...
                                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="tenDe" value="${deThi.tenDe}"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="soLanSubmit" value="${deThi.soLanSubmit}"
                                                    class="form-control"></div>
                                        </div>
                                    
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Thời gian thi
                                                  
                                                </label></div>
                                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="thoiGianThi" value="${deThi.thoiGianThi}"
                                                    class="form-control"></div>
                                        </div>
                                    </div>
                                   	<div class="col-lg-6">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><input type="datetime-local"  id="text-input" name="thoiGianMo" value="${deThi.thoiGianMo}"
                                                    class="form-control"></div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Thời gian đóng
                                                </label></div>
                                            <div class="col-12 col-md-9"><input type="datetime-local" id="text-input" name="thoiGianDong" value="${deThi.thoiGianDong}"
                                                    class="form-control"></div>
                                        </div>
                                	</div>
                                	<div class="col-lg-12">
                                        <div class="card-footer">
                                    		...
                                    		<a class="btn btn-danger btn-sm" href="DanhSachDeThi">Cancel</a>
                                    	</div>
                                    </div>   
                                </form>
                            </div>
