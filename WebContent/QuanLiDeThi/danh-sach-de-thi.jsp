                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                            <p style="color: red">${errorShowListDeThi}</p>
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${listDeThi}" var="deThi">
                                            <tr>
                                                <td>${deThi.maDe}</td>
                                                <td>${deThi.tenDe}</td>
                                                <td>${deThi.monHoc}</td>
                                                <td><a href="ChiTietDeThi?maDe=${deThi.maDe}"><i class="fa fa-eye"></i></a></td>
                                                <td><a href="ChinhSuaDeThi?maDe=${deThi.maDe}"><i class="fa fa-edit (alias)"></i></a></td>
                                                <td><a href="XoaDeThi?maDe=${deThi.maDe}"><i class="fa fa-trash-o"></i></a></td>
                                            </tr>
